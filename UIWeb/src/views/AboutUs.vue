<template>
  <div>
    <p class="page-title">Acerca de nosotros</p>
    <div class="we-container">
      <div class="question small-question">
      ...
      <div class="question small-question">
        ...
        <p class="answer">
          El sistema de administración de fondos comunes es una aplicación descentralizada que funciona sobre la cadena de bloques
      ...
      <div class="question big-question">
        ...
        <div class="answer">
          ...
          <div class="item bottom-bar">
            ...
            <p>
              La transparencia se consigue publicando las reglas con las que se define el funcionamiento de la cadena de bloques.
              Esto se logra haciendo público el código del software necesario para ejecutar la red y generando una comunidad de
          ...
          <div class="item bottom-bar">
            ...
            <p>
              ...
              registro de una transacción incluye un dato no deseado, se debe añadir una nueva transacción para revertir el error,
              pero ambas transacciones serán visibles.
            </p>
          </div>
          <div class="item bottom-bar">
            <p class="title">Privacidad</p>
            <p>
              Las direcciones de las cuentas no están ligadas a las identidades de las personas. Para poder operar en la cadenad e
              bloques es necesario disponer del par de claves pública y privada.
            </p>
          </div>
          <div class="item">
...
.we-container {
  ...
  .question {
    ...
    min-height: 100%;
    padding: 1.4rem;
    border: 0.1px solid rgba(109, 109, 109, 0.737);
    border-radius: 1rem;
    background-color: rgb(251, 251, 251);
    box-shadow: rgba(0, 0, 0, 0.42) 3px 3px 5px 3px;
