<template>
  <div>
    <div
      class="modal fade"
      :id="'profileContributionsModal' + id"
      tabindex="-1"
      :aria-labelledby="'profileContributionsModalLabel' + id"
      aria-hidden="true"
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" :id="'profileContributionsModalLabel' + id">Administradores</h4>
