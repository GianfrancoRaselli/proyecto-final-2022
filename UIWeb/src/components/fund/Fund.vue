<template>
  <div>
    ...
    <div v-else>
      <AppSpinner class="spinner" size="big" v-if="loadingFundExists" />
      <div class="error-alert-container" v-else-if="!fundExists">
        <div class="alert alert-danger error-alert" role="alert">
          <FaIcon icon="circle-exclamation" class="icon" size="5x" />
          <div class="error-msg">
            <p>¡El fondo no existe!</p>
          </div>
          <router-link class="redirect" :to="{ name: 'Funds' }">Explorar fondos</router-link>
        </div>
      </div>
      <div v-else>
              ...
              <div class="items-square-container items-container">
                ...
                <div class="item-container item-container-md">
                  <div class="item">
                    ...
                    <span class="description"
                      >Si esta opción esta activada los administradores podrán transferir el dinero del fondo sin crear una
                      solicitud previa.</span
                    >
                  </div>
                </div>
                ...
                <div class="item-container item-container-md">
                  <div class="item">
                    ...
                    <span class="description"
                      >Si esta opción esta activada se encuentra habilitada la función de crear solicitudes para retirar dinero
                      del fondo. En caso contrario, solo podrán retirar dinero los administradores.</span
                    >
                  </div>
                </div>
                ...
                <div class="item-container item-container-md">
                  <div class="item">
                    ...
                    <span class="description"
                      >Si esta opción esta activada solo los administradores podrán crear solicitudes para retirar dinero del
                      fondo. En caso contrario, cualquier entidad puede crear una solicitud que luego deberá ser aprobada para
                      retirar el dinero.</span
                    >
                  </div>
                </div>
                ...
                <div class="item-container item-container-lg">
                  <div class="item">
                    ...
                    <span class="description"
                      >Porcentaje mínimo de dinero que una entidad debe aportar al total historico de contribuciones del fondo
                      para poder aprobar una solicitud de retiro de dinero.</span
                    >
                  </div>
                </div>
          ...
          return new Promise((resolve) => {
            const searchRequests = async () => {
              const totalRequests = parseInt(
                await call({ name: 'Fund', address: this.$route.params.fundAddress }, 'requestsCount'),
              );
              let requests = [];
              if (totalRequests > 0) {
